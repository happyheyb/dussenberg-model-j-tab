var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/dussenberg-model-j-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/dussenberg-model-j-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/dussenberg-model-j-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/dussenberg-model-j-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Dussenberg Model J?",
				description: "Get awesome Dussenberg Model J HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
